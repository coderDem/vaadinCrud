package de.health.crud.task.client.samples;
...
import de.health.crud.task.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@de.health.crud.task.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
