...
- task-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- task-ui: main application module, development time
- task-production: module that produces a production mode WAR for deployment
